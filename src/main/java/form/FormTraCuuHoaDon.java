...
public class FormTraCuuHoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbMaHD.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbMaHD.setForeground(new Color(255, 255, 255));
        lbMaHD.setText("Mã hoá đơn");

        jtMaHD.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtMaHD.setBorder(null);
        jtMaHD.setPreferredSize(new Dimension(300, 40));
        ...
        lbThoiGian.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbThoiGian.setForeground(new Color(255, 255, 255));
        lbThoiGian.setText("Thời gian");

        jtThoiGian.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtThoiGian.setBorder(null);
        jtThoiGian.setPreferredSize(new Dimension(64, 40));
