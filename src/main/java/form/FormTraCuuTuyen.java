...
public class FormTraCuuTuyen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbMaTuyen = new JLabel();
        jtMaTuyen = new JTextField();
        lbTenTuyen = new JLabel();
        jtTenTuyen = new JTextField();
        lbDiemDi = new JLabel();
        jtDiemDi = new JTextField();
        lbDiemDen = new JLabel();
        jtDiemDen = new JTextField();
        lbThoiGianKhoiHanh = new JLabel();
        jtThoiGianKhoiHanh = new com.toedter.calendar.JDateChooser();
        lbThoiGianDenDuKien = new JLabel();
        ...
        tableTraCuuTuyen.setFont(new Font("SansSerif", 0, 14)); // NOI18N
        tableTraCuuTuyen.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        lbMaTuyen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbMaTuyen.setForeground(new Color(255, 255, 255));
        lbMaTuyen.setText("Mã tuyến");

        jtMaTuyen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtMaTuyen.setPreferredSize(new Dimension(300, 40));

        lbTenTuyen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbTenTuyen.setForeground(new Color(255, 255, 255));
        lbTenTuyen.setText("Tên tuyến");
        

        lbDiemDi.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbDiemDi.setForeground(new Color(255, 255, 255));
        lbDiemDi.setText("Điểm đi");

        jtDiemDi.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtDiemDi.setMinimumSize(new Dimension(64, 30));
        jtDiemDi.setPreferredSize(new Dimension(64, 40));
        
        lbDiemDen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbDiemDen.setForeground(new Color(255, 255, 255));
        lbDiemDen.setText("Điểm đến");

        lbDiemDen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbDiemDen.setMinimumSize(new Dimension(64, 30));
        lbDiemDen.setPreferredSize(new Dimension(64, 40));
        
        lbThoiGianKhoiHanh.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbThoiGianKhoiHanh.setForeground(new Color(255, 255, 255));
        lbThoiGianKhoiHanh.setText("Thời gian khởi hành");

        jtThoiGianKhoiHanh.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 0));
        jtThoiGianKhoiHanh.setAlignmentX(0.0F);
        jtThoiGianKhoiHanh.setAlignmentY(0.0F);
        jtThoiGianKhoiHanh.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtThoiGianKhoiHanh.setPreferredSize(new Dimension(88, 40));
        jtThoiGianKhoiHanh.setDateFormatString("dd/MM/yyyy");
        
        lbThoiGianDenDuKien.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbThoiGianDenDuKien.setForeground(new Color(255, 255, 255));
        lbThoiGianDenDuKien.setText("Thời gian khởi hành");

        jtThoiGianDenDuKien.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 0));
        jtThoiGianDenDuKien.setAlignmentX(0.0F);
        jtThoiGianDenDuKien.setAlignmentY(0.0F);
        jtThoiGianDenDuKien.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtThoiGianDenDuKien.setPreferredSize(new Dimension(88, 40));
        jtThoiGianDenDuKien.setDateFormatString("dd/MM/yyyy");
        
        lbTrangThai.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbTrangThai.setForeground(new Color(255, 255, 255));
        lbTrangThai.setText("Trạng thái");

        jcbTrangThai.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        ...
        btnLoc.setPreferredSize(new Dimension(103, 55));
        ...
        jtMaTuyen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtMaTuyen.setPreferredSize(new Dimension(64, 40));
    ...
    private void jtSDTActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jtSDTActionPerformed
...
//    	    }
    ...
    private void jcbTrangThaiActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jcbTrangThaiActionPerformed
        // TODO add your handling code here:
    }// GEN-LAST:event_jcbTrangThaiActionPerformed

    private void jtMaNVActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jtMaNVActionPerformed
        // TODO add your handling code here:
    ...
    private void btnLocActionPerformed(ActionEvent evt) {// GEN-FIRST:event_btnLocActionPerformed
        // TODO add your handling code here:
    ...
    private JTextField jtTenTuyen;
    private JTextField jtMaTuyen;
    private JLabel lbTenTuyen;
    private JLabel lbMaTuyen;
