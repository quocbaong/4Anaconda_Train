...
public class FormTraCuuVe extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setOpaque(false);
        setPreferredSize(new Dimension(1430, 968));
        ...
        lbMaVe.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbMaVe.setForeground(new Color(255, 255, 255));
        lbMaVe.setText("Mã vé");

        jtMaVe.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtMaVe.setBorder(null);
        jtMaVe.setPreferredSize(new Dimension(300, 40));
        ...
        lbCCCD.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbCCCD.setForeground(new Color(255, 255, 255));
        lbCCCD.setText("CCCD");

        jtCCCD.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        ...
        lbHoTen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        lbHoTen.setForeground(new Color(255, 255, 255));
        lbHoTen.setText("Họ tên ");

        jtHoTen.setFont(new Font("SansSerif", 0, 16)); // NOI18N
        jtHoTen.setBorder(null);
        jtHoTen.setPreferredSize(new Dimension(64, 40));
        ...
        btnXoaTrang.setFont(new Font("SansSerif", 0, 18)); // NOI18N
        ...
        btnTraCuu.setFont(new Font("SansSerif", 0, 18)); // NOI18N
