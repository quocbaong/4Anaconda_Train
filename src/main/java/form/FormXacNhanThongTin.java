...
public class FormXacNhanThongTin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new Font("Segoe UI Variable", 1, 48)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Xác nhận thông tin mua vé tàu");

        jLabel2.setFont(new Font("Segoe UI Variable", 1, 30)); // NOI18N
        ...
        jPanel3.setBorder(BorderFactory.createLineBorder(new Color(102, 102, 255), 2));

        jLabel3.setFont(new Font("Segoe UI Variable", 1, 36)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Thông tin khách hàng");

        jLabel4.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        jLabel4.setForeground(new Color(102, 102, 255));
        jLabel4.setText("Họ và tên");

        jLabel5.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        jLabel5.setForeground(new Color(102, 102, 255));
        jLabel5.setText("Số điện thoại");

        jLabel6.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        jLabel6.setForeground(new Color(102, 102, 255));
        jLabel6.setText("Số CCCD");

        jLabel7.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        jLabel7.setForeground(new Color(102, 102, 255));
        jLabel7.setText("Email");

        txtHoTen.setFont(new Font("Segoe UI", 0, 18)); // NOI18N
        txtHoTen.setBorder(BorderFactory.createLineBorder(new Color(153, 153, 153), 2));
        txtHoTen.setPreferredSize(new Dimension(71, 32));

        txtSDT.setFont(new Font("Segoe UI", 0, 18)); // NOI18N
        txtSDT.setBorder(BorderFactory.createLineBorder(new Color(153, 153, 153), 2));
        txtSDT.setPreferredSize(new Dimension(71, 32));

        txtCCCD.setFont(new Font("Segoe UI", 0, 18)); // NOI18N
        txtCCCD.setBorder(BorderFactory.createLineBorder(new Color(153, 153, 153), 2));
        txtCCCD.setPreferredSize(new Dimension(71, 32));

        txtEmail.setFont(new Font("Segoe UI", 0, 18)); // NOI18N
        txtEmail.setBorder(BorderFactory.createLineBorder(new Color(153, 153, 153), 2));
        txtEmail.setPreferredSize(new Dimension(71, 32));
        ...
        btnQuayLai.setBackground(new Color(242, 242, 242));
        btnQuayLai.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/back.png"))); // NOI18N
        btnQuayLai.setBorder(null);

        jLabel8.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        jLabel8.setText("Quay lại");

        btnXemHDTreo.setBackground(new Color(204, 204, 255));
        btnXemHDTreo.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        btnXemHDTreo.setForeground(new Color(102, 102, 255));
        ...
        btnTreoHD.setBackground(new Color(204, 204, 255));
        btnTreoHD.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        btnTreoHD.setForeground(new Color(102, 102, 255));
        ...
        btnThanhToan.setFont(new Font("Segoe UI Variable", 1, 24)); // NOI18N
        btnThanhToan.setForeground(new Color(102, 102, 255));
