...
public class FormListDontreo extends JFrame {
    ...
    private void initComponents() {
        ...
        jtCCCD.setPreferredSize(new Dimension(64, 35));

        jtSĐT.setPreferredSize(new Dimension(64, 35));

        btnTim.setBackground(new Color(0, 199, 255));
        ...
        btnTim.setPreferredSize(new Dimension(75, 50));
        ...
        btnXuLy.setBackground(new Color(0, 199, 255));
        btnXuLy.setFont(new Font("SansSerif", 1, 20)); // NOI18N
        btnXuLy.setText("Xử lý");
        btnXuLy.setBorder(null);
        btnXuLy.setPreferredSize(new Dimension(75, 50));
        ...
        btnHuy.setFont(new Font("SansSerif", 1, 20)); // NOI18N
